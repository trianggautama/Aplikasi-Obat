...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2>Pemusnahan Obat Dinkes</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="index.html">Pemusnahan Obat Dinkes</a>
                </li>
                <li class="breadcrumb-item">
                    <strong>Cetak</strong>
                </li>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{Route('userDinkes.report.pemusnahan_obat_dinkes2.filter.cetak')}}" method="GET" target="__blank">
