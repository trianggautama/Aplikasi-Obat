                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('userDinkes.kategori.destroy',$d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-warning" href="{{Route('userDinkes.kategori.edit',$d->id)}}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{{Route('userDinkes.kategori.store')}}" method="POST">
                    @csrf
