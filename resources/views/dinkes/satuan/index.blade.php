                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('userDinkes.satuan.destroy',$d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-warning" href="{{Route('userDinkes.satuan.edit',$d->id)}}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{{Route('userDinkes.satuan.store')}}" method="POST">
                    @csrf
