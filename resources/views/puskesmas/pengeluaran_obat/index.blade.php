    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <a href="{{Route('userPuskesmas.report.pengeluaran_obat.filter')}}" class="btn btn-info"><i class=" fa fa-print"></i> Filter Cetak Data</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('userPuskesmas.pengeluaran_puskesmas.destroy',$d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-info" href="{{Route('userPuskesmas.pengeluaran_puskesmas.show',$d->id)}}"><i class="fa fa-info-circle"></i>&nbsp;Detail</a>
                                            <a class="btn btn-warning" href="{{Route('userPuskesmas.pengeluaran_puskesmas.edit',$d->id)}}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{{Route('userPuskesmas.pengeluaran_puskesmas.store')}}" method="POST">
                    @csrf
